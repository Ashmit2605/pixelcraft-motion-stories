...
const baseGalleryItems: Omit<GalleryItem, "effect" | "angle">[] = [
    ...
    {
        id: "18",
        src: "https://drive.google.com/thumbnail?id=1xKWhpbHw0xZNdSXmCGpCDywXLbcKOpWQ&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1xKWhpbHw0xZNdSXmCGpCDywXLbcKOpWQ&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "10",
        src: "https://drive.google.com/thumbnail?id=1LVt9qM2V05sZoBeqvsKtmiABjJ6Cj53D&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1LVt9qM2V05sZoBeqvsKtmiABjJ6Cj53D&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "11",
        src: "https://drive.google.com/thumbnail?id=1ZvKQjJ2ulGG5F9UDJvMc0FfIOSeibaYT&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1ZvKQjJ2ulGG5F9UDJvMc0FfIOSeibaYT&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "12",
        src: "https://drive.google.com/thumbnail?id=15qd8g15eZ2B98P4nkFbczaYcLU7jcRlb&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=15qd8g15eZ2B98P4nkFbczaYcLU7jcRlb&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "13",
        src: "https://drive.google.com/thumbnail?id=11Gu-yy-zqWZWlPrLtBY_MOMM1bg5EhFZ&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=11Gu-yy-zqWZWlPrLtBY_MOMM1bg5EhFZ&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "14",
        src: "https://drive.google.com/thumbnail?id=17bnkyNBrNynd3GQfy5mJoBWCeU5-a5-D&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=17bnkyNBrNynd3GQfy5mJoBWCeU5-a5-D&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "15",
        src: "https://drive.google.com/thumbnail?id=1Zv9CfkmwalMF0foq5Teyl8h4UcJT4bRh&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1Zv9CfkmwalMF0foq5Teyl8h4UcJT4bRh&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "16",
        src: "https://drive.google.com/thumbnail?id=1zP-pDvbHJBu-AzH9Wsbx1q6o3P1Da2fD&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1zP-pDvbHJBu-AzH9Wsbx1q6o3P1Da2fD&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
    ...
    {
        id: "17",
        src: "https://drive.google.com/thumbnail?id=1eGUlwsa9KPCNp_PviDfIOjbg-1XdxSx0&sz=w1000",
        thumbnail: "https://drive.google.com/thumbnail?id=1eGUlwsa9KPCNp_PviDfIOjbg-1XdxSx0&sz=w400",
        title: "",
        location: "",
        year: "",
        category: "workshop",
...
const GalleryCard = ({ item, index, onClick }: { item: GalleryItem; index: number; onClick: () => void }) => {
        ...
        <>
            {item.type === "video" ? (
                ...
                <img
                    ...
                    onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?w=600&h=600&fit=crop";
                        setImageLoaded(true);
                    }}
                />
            )}
    ...
    useEffect(() => {
        // Videos don't fire onLoad, so mark them as loaded immediately
        if (item.type === "video") {
            setImageLoaded(true);
        }
    }, [item.type]);
